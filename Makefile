...
docs/source:
	@echo "Compiling docs..."
	@mkdir -p docs/source
	@PYTHONPATH=".:importer/:importer/lib:importer/lib/dist:$PYTHONPATH" sphinx-apidoc -o docs/source -l --full -H "Importer" -A "Sam Gammon" -V "0.1" -R "sample" -d 1 ./importer
...
test: testdeps
	...
	@rm -f .coverage
	@nosetests -w tests/ --with-coverage --cover-package=importer --cover-branches
